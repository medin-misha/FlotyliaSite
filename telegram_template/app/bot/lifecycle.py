...
from app.modules.notifications.runtime import shutdown_notifications_runtime, startup_notifications_runtime
...
def register_lifecycle(dispatcher: Dispatcher, settings: MainSettings) -> None:
    ...
    async def on_startup(bot: Bot) -> None:
        ...
        await startup_notifications_runtime(bot)
    ...
    async def on_shutdown(bot: Bot) -> None:
        ...
        await shutdown_notifications_runtime()
