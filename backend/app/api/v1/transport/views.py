...
async def create_transport(data: TransportCreate, session: SessionDep, admin: AdminDep) -> TransportReturn:
...
async def get_transport(id: int, session: SessionDep, admin: AdminDep) -> TransportReturn:
