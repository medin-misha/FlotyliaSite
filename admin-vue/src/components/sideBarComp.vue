...
<template>
  <aside
    class="fixed left-0 top-0 z-50 flex h-full w-sidebar-width flex-col overflow-y-auto border-r border-outline-variant/30 bg-surface-container-lowest p-stack-md shadow-sm transition-colors duration-300 dark:border-white/10 dark:bg-inverse-surface/95 dark:shadow-none"
  >
    <!-- Logo Section -->
    ...
    <div class="mt-auto space-y-2 pt-6 border-t border-outline-variant/30 dark:border-white/10">
      ...
      <!-- Admin Profile Card -->
      <div
        class="flex items-center gap-3 p-3 mt-4 bg-surface-container-high dark:bg-white/5 rounded-2xl"
      >
        <div class="overflow-hidden">
          <p class="truncate font-label-md text-label-md font-bold">
